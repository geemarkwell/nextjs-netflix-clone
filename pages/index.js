  ...
  return (
    ...
    >
        ...
        <div>
          {!session ? (
            <button
              ...
              className='bg-[#e50914] text-white text-sm px-4 py-2 rounded flex items-center'
            >
              {' '}
              Sign In
            </button>
      ...
      <main className='flex flex-col items-center justify-center flex-1 px-20 text-center'>
        <h1 className='text-6xl font-medium text-white max-w-xlg tracking-wide'>
          Unlimited movies, TV shows, and more.
        </h1>
        <h2 className='text-2xl text-white mt-4 my-4 mb-8'>
        ...
        <div className='flex mt-4'>
          ...
          <button
            onClick={() => signIn('google')}
            className='bg-[#e50914] text-white text-lg px-8 flex items-center'
          >
            Get Started
            <svg
              xmlns='http://www.w3.org/2000/svg'
